...
local function greetCallback(cid)
	...
	if player:getStorageValue(JOIN_STOR) == -1 then
		...
		npcHandler:setMessage(MESSAGE_GREET, 'Welcome back old chap. What brings you here this time? You can {report} your status, see the tasks {status}, and ask for {rank} to see what rank you are. The higher rank, the more tasks you will get.')
	end
	return true
end
