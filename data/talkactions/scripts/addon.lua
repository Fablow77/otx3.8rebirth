...
local msg = {"To use the command, you need to have your outfit doll in your backpack, and say !addon outfit name. For example, !outfit citizen", "You need to have the addon doll in your backpack.", "Bad param!", "Full Addon Set sucesfully added!"} 
local param = string.lower(param) 

if(getPlayerItemCount(cid, 8985) > 0) then 
if(param ~= "" and maleOutfits[param] and femaleOutfits[param]) then 
doPlayerRemoveItem(cid, 8985, 1) 
