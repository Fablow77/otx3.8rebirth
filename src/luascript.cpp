...
void LuaScriptInterface::registerFunctions()
{
	...
	registerMethod("House", "getRequiredRebirth", LuaScriptInterface::luaHouseGetRequiredRebirth);
...
int LuaScriptInterface::luaPlayerDoRebirth(lua_State* L)
{
	// player:doRebirth()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
...
int LuaScriptInterface::luaPlayerGetRebirth(lua_State* L) // rebirth
{
	// player:getRebirth()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
...
int LuaScriptInterface::luaHouseGetRequiredRebirth(lua_State* L)
{
